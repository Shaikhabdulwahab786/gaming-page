        ...
        <section className="bg-black pb-52">
            <div className="container mx-auto  px-3 md:px-10 ">
                <div className="px-5 py-32">
                    ...
                    <p className="max-w-md  font-circular-web  text-lg  text-blue-50  opacity-50">Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam necessitatibus corporis laudantium aspernatur vel voluptas, delectus debitis expedita labore consequatur!</p>
                </div>
